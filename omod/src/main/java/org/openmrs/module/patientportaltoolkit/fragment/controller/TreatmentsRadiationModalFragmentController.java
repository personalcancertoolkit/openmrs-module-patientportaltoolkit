...
public class TreatmentsRadiationModalFragmentController {
    ...
    public void controller(FragmentModel model, PageRequest pageRequest) {
        ...
        model.addAttribute("radiationConcepts", patientPortalFormService
                .getPatientPortalFormByFormType(PatientPortalToolkitConstants.RADIATION_ENCOUNTER));

    }

    public void saveNewRadiationForm(FragmentModel model,
        ...
        log.info(PPTLogAppender.appendLog("NEW_RADIATION", servletRequest, "radiationTypes:", radiationTypes,
                "radiationStartDate:", radiationStartDate, "radiationEndDate:", radiationEndDate, "radiationPcpName:",
                radiationPcpName, "radiationPcpPhone:", radiationPcpPhone, "radiationInstitutionName:",
                radiationInstitutionName, "radiationInstitutionCity:", radiationInstitutionCity,
                "radiationInstitutionState:", radiationInstitutionState));
        EncounterService encounterService = Context.getEncounterService();
        Encounter newRadiationEncounter = new Encounter();
        if (patientUuid == null || patientUuid.isEmpty()) {
            newRadiationEncounter.setPatient(
        ...
        newRadiationEncounter
                .setEncounterType(encounterService.getEncounterType(PatientPortalToolkitConstants.RADIATION_ENCOUNTER));
    ...
    public void saveRadiationForm(FragmentModel model,
        ...
        log.info(PPTLogAppender.appendLog("SAVE_EXISTING_RADIATION", servletRequest, "encounterId:", encounterId,
                "radiationTypes:", radiationTypes, "radiationStartDate:", radiationStartDate, "radiationEndDate:",
                radiationEndDate, "radiationPcpName:", radiationPcpName, "radiationPcpPhone:", radiationPcpPhone,
                "radiationInstitutionName:", radiationInstitutionName, "radiationInstitutionCity:",
                radiationInstitutionCity, "radiationInstitutionState:", radiationInstitutionState));
        EncounterService encounterService = Context.getEncounterService();
        ConceptService conceptService = Context.getConceptService();
        String[] str_array = radiationTypes.split("split");
        List<String> radiationTypesConcepts = new ArrayList<>();
        ...
        if (encounterId != null) {
            ...
            for (String entry : allTheEnteredValues) {
                if (entry != null) {
                    switch (entry) {
                        case "radiationTypes":
                            for (Obs o : radiationObservationConceptUUIDToObsMap
                                    .get("42fb7bb5-f840-4518-814c-893813211cba"))
                                existingRadiationTypesConcepts.add(o.getValueCoded().getUuid());
                            break;
                        case "radiationStartDate":
                            if (radiationObservationConceptUUIDToObsMap
                                    .get("85c3a99e-0598-4c63-912b-796dee9c75b2") != null) {
                                Obs o = radiationObservationConceptUUIDToObsMap
                                        .get("85c3a99e-0598-4c63-912b-796dee9c75b2").get(0);
                                if (radiationStartDate != null && radiationStartDate != "") {
                                    SimpleDateFormat formatter = new SimpleDateFormat("MM/dd/yyyy");
                                    Date parsedDate = formatter.parse(radiationStartDate);
                                ...
                                if (radiationStartDate != null && radiationStartDate != "") {
                                    Obs o = new Obs();
                                    o.setConcept(
                                            conceptService.getConceptByUuid("85c3a99e-0598-4c63-912b-796dee9c75b2"));
                                    SimpleDateFormat formatter = new SimpleDateFormat("MM/dd/yyyy");
                                    Date parsedDate = formatter.parse(radiationStartDate);
                                    o.setValueDate(parsedDate);
                        ...
                        case "radiationEndDate":
                            if (radiationObservationConceptUUIDToObsMap
                                    .get("7dd8b8aa-b0f1-4eb1-862d-b6d737bdd315") != null) {
                                Obs o = radiationObservationConceptUUIDToObsMap
                                        .get("7dd8b8aa-b0f1-4eb1-862d-b6d737bdd315").get(0);
                                if (radiationEndDate != null && radiationEndDate != "") {
                                    SimpleDateFormat formatter = new SimpleDateFormat("MM/dd/yyyy");
                                    Date parsedDate = formatter.parse(radiationEndDate);
                                    if (o.getValueDate() != parsedDate)
                                ...
                                if (radiationEndDate != null && radiationEndDate != "") {
                                    Obs o = new Obs();
                                    o.setConcept(
                                            conceptService.getConceptByUuid("7dd8b8aa-b0f1-4eb1-862d-b6d737bdd315"));
                                    SimpleDateFormat formatter = new SimpleDateFormat("MM/dd/yyyy");
                                    Date parsedDate = formatter.parse(radiationEndDate);
                                    o.setValueDate(parsedDate);
                                    chemotherapyEncounter.addObs(o);
                        ...
                        case "radiationPcpName":
                            if (radiationObservationConceptUUIDToObsMap
                                    .get("c2cb2220-c07d-47c6-a4df-e5918aac3fc2") != null) {
                                Obs o = radiationObservationConceptUUIDToObsMap
                                        .get("c2cb2220-c07d-47c6-a4df-e5918aac3fc2").get(0);
                        ...
                        case "radiationPcpPhone":
                            if (radiationObservationConceptUUIDToObsMap
                                    .get("9285b227-4054-4830-ac32-5ea78462e8c4") != null) {
                                Obs o = radiationObservationConceptUUIDToObsMap
                                        .get("9285b227-4054-4830-ac32-5ea78462e8c4").get(0);
                        ...
                        case "radiationInstitutionName":
                            if (radiationObservationConceptUUIDToObsMap
                                    .get("47d58999-d3b5-4869-a52e-841e2e6bdbb3") != null) {
                                Obs o = radiationObservationConceptUUIDToObsMap
                                        .get("47d58999-d3b5-4869-a52e-841e2e6bdbb3").get(0);
                                ...
                                if (radiationInstitutionName != null && radiationInstitutionName != "") {
                                    Obs o = new Obs();
                                    o.setConcept(
                                            conceptService.getConceptByUuid("47d58999-d3b5-4869-a52e-841e2e6bdbb3"));
                                    o.setValueText(radiationInstitutionName);
                                    chemotherapyEncounter.addObs(o);
                                }
                            }
                        ...
                        case "radiationInstitutionCity":
                            if (radiationObservationConceptUUIDToObsMap
                                    .get("bfa752d6-2037-465e-b0a2-c4c2d485ec32") != null) {
                                Obs o = radiationObservationConceptUUIDToObsMap
                                        .get("bfa752d6-2037-465e-b0a2-c4c2d485ec32").get(0);
                                ...
                                if (radiationInstitutionCity != null && radiationInstitutionCity != "") {
                                    Obs o = new Obs();
                                    o.setConcept(
                                            conceptService.getConceptByUuid("bfa752d6-2037-465e-b0a2-c4c2d485ec32"));
                                    o.setValueText(radiationInstitutionCity);
                                    chemotherapyEncounter.addObs(o);
                                }
                            }
                        ...
                        case "radiationInstitutionState":
                            if (radiationObservationConceptUUIDToObsMap
                                    .get("34489100-487e-443a-bf27-1b6869fb9332") != null) {
                                Obs o = radiationObservationConceptUUIDToObsMap
                                        .get("34489100-487e-443a-bf27-1b6869fb9332").get(0);
                                ...
                                if (radiationInstitutionState != null && radiationInstitutionState != "") {
                                    Obs o = new Obs();
                                    o.setConcept(
                                            conceptService.getConceptByUuid("34489100-487e-443a-bf27-1b6869fb9332"));
                                    o.setValueText(radiationInstitutionState);
                                    chemotherapyEncounter.addObs(o);
                                }
                            }
