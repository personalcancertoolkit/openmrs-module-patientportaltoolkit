...
public class CommunitiesPageController {
    ...
    public void controller(PageModel model, PageRequest pageRequest) {
        Context.getService(PatientPortalMiscService.class).logEvent("COMMUNITIES_PAGE_VIEWED",null);
        log.info(PPTLogAppender.appendLog("REQUEST_COMMUNITIES_PAGE", pageRequest.getRequest()));
