    ...
    public void addRelationshipfromForm(FragmentModel model,
        ...
        if (!personExists) {
            ...
            String bodyText = "Hello " + person.getPersonName() + ", <br/><br/>"
                    + user.getPersonName()
                    + " added you as a connection on SPHERE. Please visit https://sphere.regenstrief.org to access your account and accept or ignore the connection request. The username for your account is "
            ...
            String content = "Hello " + person.getPersonName() + ",\n\n"
                    + user.getPersonName()
                    + " added you as a connection on SPHERE. Please login at https://sphere.regenstrief.org to accept or ignore the connection request.";
