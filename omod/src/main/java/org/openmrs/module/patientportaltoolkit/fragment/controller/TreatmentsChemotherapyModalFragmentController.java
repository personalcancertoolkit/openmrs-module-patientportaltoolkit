...
public class TreatmentsChemotherapyModalFragmentController {
    ...
    public void controller(FragmentModel model, PageRequest pageRequest) {
        ...
        model.addAttribute("chemotherapyConcepts", patientPortalFormService
                .getPatientPortalFormByFormType(PatientPortalToolkitConstants.CHEMOTHERAPY_ENCOUNTER));

    }

    public void saveNewChemotherapyForm(FragmentModel model,
        ...
        log.info(PPTLogAppender.appendLog("NEW_CHEMOTHERAPY", servletRequest, "chemotherapyMeds:", chemotherapyMeds,
                "centralLine:", centralLine, "chemoStartDate:", chemoStartDate, "chemoEndDate:", chemoEndDate,
                "chemotherapyPcpName:", chemotherapyPcpName, "chemotherapyPcpPhone:", chemotherapyPcpPhone,
                "chemotherapyInstitutionName:", chemotherapyInstitutionName, "chemotherapyInstitutionCity:",
                chemotherapyInstitutionCity, "chemotherapyInstitutionState:", chemotherapyInstitutionState));
        EncounterService encounterService = Context.getEncounterService();
        Encounter newChemotherapyEncounter = new Encounter();
        if (patientUuid == null || patientUuid.isEmpty()) {
            newChemotherapyEncounter.setPatient(
        ...
        newChemotherapyEncounter.setEncounterType(
                encounterService.getEncounterType(PatientPortalToolkitConstants.CHEMOTHERAPY_ENCOUNTER));
            ...
            if (entry != null) {
                switch (entry) {
                    ...
                    case "chemotherapyInstitutionName":
                        ...
                        chemotherapyInstitutionNameObs
                    ...
                    case "chemotherapyInstitutionCity":
                        ...
                        chemotherapyInstitutionCityObs
                    ...
                    case "otherChemotherapyMedicationName":
                        ...
                        otherChemotherapyMedicationNameObs
                                .setConcept(conceptService.getConceptByUuid("3a49bfbb-df57-4c51-9f14-f05f848093e0"));
        ...
        // log.info("Save New Chemotherapy for -" +
    ...
    public void saveChemotherapyForm(FragmentModel model,
        ...
        log.info(PPTLogAppender.appendLog("UPDATE_CHEMOTHERAPY", servletRequest, "chemotherapyMeds:", chemotherapyMeds,
                "centralLine:", centralLine, "chemoStartDate:", chemoStartDate, "chemoEndDate:", chemoEndDate,
                "chemotherapyPcpName:", chemotherapyPcpName, "chemotherapyPcpPhone:", chemotherapyPcpPhone,
                "chemotherapyInstitutionName:", chemotherapyInstitutionName, "chemotherapyInstitutionCity:",
                chemotherapyInstitutionCity, "chemotherapyInstitutionState:", chemotherapyInstitutionState));
                    ...
                    switch (entry) {
                        ...
                        case "centralLine":
                            if (observationConceptUUIDToObsMap.get("361b7f9b-a985-4b18-9055-03af3b41b8b3") != null) {
                                Obs o = observationConceptUUIDToObsMap.get("361b7f9b-a985-4b18-9055-03af3b41b8b3")
                                        .get(0);
                                o.setValueCoded(conceptService.getConceptByUuid(centralLine));
                            } else {
                                Obs o = new Obs();
                        ...
                        case "chemoStartDate":
                            if (observationConceptUUIDToObsMap.get("85c3a99e-0598-4c63-912b-796dee9c75b2") != null) {
                                Obs o = observationConceptUUIDToObsMap.get("85c3a99e-0598-4c63-912b-796dee9c75b2")
                                        .get(0);
                                if (chemoStartDate != null && chemoStartDate != "") {
                                    SimpleDateFormat formatter = new SimpleDateFormat("MM/dd/yyyy");
                                    Date parsedDate = formatter.parse(chemoStartDate);
                        ...
                        case "chemoEndDate":
                            if (observationConceptUUIDToObsMap.get("7dd8b8aa-b0f1-4eb1-862d-b6d737bdd315") != null) {
                                Obs o = observationConceptUUIDToObsMap.get("7dd8b8aa-b0f1-4eb1-862d-b6d737bdd315")
                                        .get(0);
                                if (chemoEndDate != null && chemoEndDate != "") {
                                    SimpleDateFormat formatter = new SimpleDateFormat("MM/dd/yyyy");
                                    Date parsedDate = formatter.parse(chemoEndDate);
                        ...
                        case "otherChemotherapyMedicationName":
                            if (observationConceptUUIDToObsMap.get("34489100-487e-443a-bf27-1b6869fb9332") != null) {
                                Obs o = observationConceptUUIDToObsMap.get("3a49bfbb-df57-4c51-9f14-f05f848093e0")
                                        .get(0);
                                ...
                                if (otherChemotherapyMedicationName != null && otherChemotherapyMedicationName != "") {
                                    Obs otherChemotherapyMedicationNameObs = new Obs();
                                    otherChemotherapyMedicationNameObs.setConcept(
                                            conceptService.getConceptByUuid("3a49bfbb-df57-4c51-9f14-f05f848093e0"));
                                    otherChemotherapyMedicationNameObs.setValueText(otherChemotherapyMedicationName);
