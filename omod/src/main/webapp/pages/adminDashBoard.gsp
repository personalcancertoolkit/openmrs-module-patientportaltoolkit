...
<form id="adminDashCardForm" class="form-horizontal col-xs-12">
            ...
            <div id="tabs">
                <ul>
                    <li><a href="#tabs-1">Check Concept Name and ID </a></li>
                ...
                <div id="tabs-1">
                        <div class="clearfix">
                            <div id="divGuideLine" style="margin: auto;width: 75%;border: 3px solid black;padding: 10px;">
                                <div class="clearfix">
                                      <b> Check Concept Name and ID </b> &emsp;&emsp;
                                      <br />
                                      <br />
                                      <div>
                                            <label><b>Find a concept by typing in its name or Id:</b></label>
                                            <input class="form-control" id="txtConcept" type="text" />
                                            button type="button" class="btn btn-primary" id="btnGetConcept">Save</button>
                                      </div>
                                </div>
                            </div>
                       ...
                       <div class="clearfix">
                            <div id="divSideEffectRuleConceptMap" style="margin: auto;width: 75%;border: 3px solid black;padding: 10px;">
                                <div class="clearfix">
                                      ...
                                      <div class="clearfix">
                                        <b>Categorize/Create Side Effect Rules</b> &emsp;&emsp;
