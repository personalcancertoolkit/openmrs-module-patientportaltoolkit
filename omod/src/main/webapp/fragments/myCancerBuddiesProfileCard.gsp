    ...
    <div class="col-xs-6">
        <div class="row well profile form-horizontal">
            <div class="form-group">
                <label class="control-label col-xs-6" for="mycancerbuddiesnameh6">Screen Name: 
                    <i data-toggle="tooltip" data-placement="top" title="" data-original-title="The name you choose will be visible to other MyCancerBuddies Patients" class="glyphicon glyphicon-question-sign"></i>
                </label>
                <div class="col-xs-6"> 
                    <h6 id="mycancerbuddiesnameh6" data-toggle="tooltip" data-placement="top" title="" data-original-title="Click on this to edit how your name appears as to others">
                        <p><strong id="mycancerbuddiesname" class="edit mycancerbuddies"> ${(personPreferences.myCancerBuddiesName)}</strong>
                        </p>
                    </h6>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-xs-6">  
                    <h6 id="mycancerbuddiesAgeh6" >
                        <p id="mycancerbuddiesAge" >
                            <% if (personPreferences.person.birthdate && !personPreferences.person.getBirthdate().is(null) ){ %>
                                <% if (person.age > 0) { %>
            ...
            <div class="form-group">
                <label class="control-label col-xs-6" for="mycancerbuddiesdescriptionh6">Screen Description: 
                    <i data-toggle="tooltip" 
                        data-placement="top" 
                        title="" 
                        data-original-title="This is a short introduction about what you would like others to know about you" 
                        class="glyphicon glyphicon-question-sign">
                    </i>
                </label>
                <div class="col-xs-6">  
                    <h6 id="mycancerbuddiesdescriptionh6"  
                        data-toggle="tooltip" 
                        data-placement="top"
                        title="" 
                        data-original-title="Click on this to edit how your description appears as to others">
                        <p id="mycancerbuddiesdescription" data-type="textarea" class="edit mycancerbuddies">${(personPreferences.myCancerBuddiesDescription)}
                        </p>
                    </h6>
                </div>
            </div>
