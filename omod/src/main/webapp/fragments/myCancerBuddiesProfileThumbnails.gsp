            ...
            <%   
                ...
                if (mycancerbuddiespreferences.myCancerBuddies==true) { 
                    ...
                    if (pptrelation  && pptrelation.retired == false && pptrelation.shareStatus==0) { 
                        the_button_to_display = '<hr/><i class="material-icons text-warning">alarm</i><label class="text-warning">  Request Pending</label>';
                    }
                    if (pptrelation  && pptrelation.retired == false && pptrelation.shareStatus==1) {
                        the_button_to_display = '<hr/><i class="material-icons text-success">sentiment_very_satisfied</i><label class="text-success">  Connected</label>';
                    }
