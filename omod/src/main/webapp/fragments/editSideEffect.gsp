...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
             <h4 class="modal-title">Side Effect up Rules</h4>
        ...
        <div class="modal-body">
            ...
            <form class="form-inline" role="form">
                <label class="reformatText">Add New Concept Name (Only One Concept)</label>
                <input class="form-control" id="addNewSideEffect_Concept" type="text" />
            </form>
            <br />
        </div>
