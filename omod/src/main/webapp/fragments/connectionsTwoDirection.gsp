                ...
                <div class="media-body">
                    ...
                    <form class="form-inline" role="form">
                        ...
                        <div class="form-group">
                            <span id="${ twoDirectionFragmentRelation.uuid }relationType" hidden>${ (twoDirectionFragmentRelation.getRelationType().getId()) }</span> ${ (twoDirectionFragmentRelation.getRelationType().getaIsToB()) } -  <span id="${ twoDirectionFragmentRelation.uuid }relationShare"> This Person ${twoDirectionFragmentRelation.getShareTypeA().getDescription()}</span> -  <span> You ${twoDirectionFragmentRelation.getShareTypeB().getDescription()}</span> <input id="${ twoDirectionFragmentRelation.uuid }relationShareID" value="${twoDirectionFragmentRelation.getShareTypeA().getUuid()}" type="hidden"/>
                        </div>
                        <% } %>
                        <% if(twoDirectionFragmentSide=="bIsToA") { %>
                        <div class="form-group">
                            <span id="${ twoDirectionFragmentRelation.uuid }relationType" hidden>${ (twoDirectionFragmentRelation.getRelationType().getId()) }</span> ${ (twoDirectionFragmentRelation.getRelationType().getaIsToB()) } -  <span id="${ twoDirectionFragmentRelation.uuid }relationShare"> This Person ${twoDirectionFragmentRelation.getShareTypeB().getDescription()}</span> -  <span> You ${twoDirectionFragmentRelation.getShareTypeA().getDescription()}</span> <input id="${ twoDirectionFragmentRelation.uuid }relationShareID" value="${twoDirectionFragmentRelation.getShareTypeB().getUuid()}" type="hidden"/>
                        </div>
                        <% } %>
                    </form>
