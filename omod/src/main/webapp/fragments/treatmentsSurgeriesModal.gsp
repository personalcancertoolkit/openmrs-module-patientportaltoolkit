<div class="modal fade modal-wide treatment_form_uniform_label_width"  id="edit-surgeries-modal" role="dialog" aria-labelledby="editSurgeriesLabel" aria-hidden="true">
